...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zexcoin.conf'
CONFIGFOLDER='/root/.zexcoincore'
COIN_DAEMON='/usr/local/bin/zexcoind'
COIN_CLI='/usr/local/bin/zexcoin-cli'
COIN_REPO='https://github.com/zexcoins/zexcoincore.git'
COIN_NAME='Zex'
COIN_PORT=7736
RPCPORT=7382
